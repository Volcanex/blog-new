...
<main class="photo-page">
    ...
    <div class="photo-caption">
        <h2>Untitled (diptych), 2025</h2>
        <p>Two silver gelatin hand-prints, 12 &times; 16 inches each</p>
    </div>
    <div class="photo-nav">
        <a href="../np-in-the-wings/">&larr; Previous</a>
        <a href="../contemplation/">Next &rarr;</a>
    </div>
</main>
</html>