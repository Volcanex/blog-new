...
.nav-dropdown.open li:nth-child(1) { transition-delay: 0.04s; }
.nav-dropdown.open li:nth-child(2) { transition-delay: 0.08s; }
.nav-dropdown.open li:nth-child(3) { transition-delay: 0.12s; }
.nav-dropdown.open li:nth-child(4) { transition-delay: 0.16s; }
.nav-dropdown.open li:nth-child(5) { transition-delay: 0.20s; }
.nav-dropdown.open li:nth-child(6) { transition-delay: 0.24s; }
...
.photo-caption {
    margin-top: 28px;
    text-align: center;
    animation: gentleFade 0.8s ease-out 0.6s both;
}
.photo-caption h2 {
    font-size: 1.15rem;
    font-weight: 400;
...
.photo-nav {
    ...
    gap: 28px;
    margin-top: 32px;
    animation: gentleFade 0.8s ease-out 0.8s both;
}
.photo-nav a {
    font-size: 12px;
    color: var(--text-light);
...
@media (max-width: 768px) {
    ...
    .photo-page img { max-height: 60vh; }
    .photo-caption { margin-top: 20px; }
    .photo-caption h2 { font-size: 1rem; }
    .photo-nav { margin-top: 20px; gap: 20px; }
}
</style>
<html>
...
<div class="sidebar">
    ...
    <nav class="nav-section">
        ...
        <div class="nav-dropdown open"><ul>
...
<main class="photo-page">
    ...
    <div class="photo-caption">
        <h2>NP in the wings, 2025</h2>
        <p>Silver gelatin hand-print, 12 &times; 16 inches</p>
    </div>
    <div class="photo-nav">
        <a href="../jonis-angel/">&larr; Previous</a>
        <a href="../portrait-study/">Next &rarr;</a>
    </div>
</main>
</html>