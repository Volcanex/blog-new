...
<main class="bookings-page">
    <div class="bookings-content">
        <h1>Bookings</h1>
        <p>Available for commissions, collaborations and editorial assignments. Based in the UK, working worldwide.</p>

        <ul class="services">
            <li>Commercial &amp; brand photography</li>
            <li>Editorial &amp; press</li>
            <li>Portraiture</li>
            <li>Events &amp; documentary</li>
            <li>Creative direction</li>
            <li>Darkroom printing &amp; analogue process</li>
        </ul>

        <p>For rates, availability and project enquiries:</p>

        <div class="contact-block">
            <a href="mailto:hello@leahmclaine.com" class="email-link">hello@leahmclaine.com</a>
        ...
        <div class="enquiry-form">
            ...
            <form id="enquiryForm" onsubmit="submitEnquiry(event)">
                ...
                <div class="form-group">
                    <label for="eq-service">Service</label>
                    <select id="eq-service">
                        <option value="">Select a service...</option>
                        <option value="Commercial & brand photography">Commercial & brand photography</option>
                        <option value="Editorial & press">Editorial & press</option>
                        <option value="Portraiture">Portraiture</option>
                        <option value="Events & documentary">Events & documentary</option>
                        <option value="Creative direction">Creative direction</option>
                        <option value="Darkroom printing & analogue process">Darkroom printing & analogue process</option>
                ...
                <div class="form-group">
                    ...
                    <textarea id="eq-message" required placeholder="Tell me about your project, dates, location..."></textarea>
                </div>
                <button type="submit" class="submit-btn" id="eq-submit">Send Enquiry</button>
            </form>
            <div class="form-success" id="eq-success">Thank you. Your enquiry has been sent &mdash; I'll be in touch soon.</div>
...
async function submitEnquiry(e) {
    ...
    try {
        const res = await fetch('/api/artists/leahmclaine/bookings/submit', {
            method: 'POST',
        ...
        error.textContent = 'Could not send. Please email directly.';
        error.classList.add('show');
    }
    btn.disabled = false;
