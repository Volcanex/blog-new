...
@media (max-width: 768px) {
    .statement-page { padding: 24px 16px; min-height: auto; }
}
</style>
<html>
...
<main class="statement-page">
    ...
    <div class="statement-text">
        <h2>Darkroom notes</h2>
        <blockquote>&ldquo;The only thing that's light is the paper. You begin to see the picture emerge, through darkness.&rdquo;</blockquote>
        <p>All prints are made by hand in the darkroom on fibre-based silver gelatin paper. Leah works with 35mm and medium format black and white film, developing and printing each image herself.</p>
        <p>She taught herself to print at Trinity College, Cambridge, using expired chemicals and a shared enlarger. The process &mdash; slow, physical, irreversible &mdash; became inseparable from the subject matter: faith as something held in the body, then released.</p>
        <p>Writing accompanies the photographs as a parallel inquiry, not explanation but another way of looking.</p>
    </div>
</main>
</html>