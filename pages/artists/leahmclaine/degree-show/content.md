...
@media (max-width: 768px) {
    .photo-page { padding: 24px 16px; min-height: 50vh; }
}
</style>
<html>
...
<main class="photo-page">
    ...
    <div class="photo-caption">
        <h2>RCA Degree Show, 2025</h2>
        <p>Royal College of Art, Photography MA. Installation of silver gelatin hand-prints from Having Had Faith. Work acquired by two private collectors.</p>
    </div>
    <div class="photo-nav">
        <a href="../proposition-studios/">Next &rarr;</a>
    </div>
</main>
</html>