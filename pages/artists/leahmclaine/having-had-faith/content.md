...
@media (max-width: 768px) {
    .project-page { padding: 24px 16px; min-height: auto; }
}
</style>
<html>
...
<main class="project-page">
    ...
    <div class="project-text">
        <h2>Having Had Faith</h2>
        <p>Having Had Faith is a book of black and white silver gelatin hand-prints, exploring what remains when belief departs the body.</p>
        <p>Made during Leah's MA at the Royal College of Art between 2024&ndash;2025, the photographs centre on Cambridge's queer community &mdash; the people who became a kind of congregation after organised religion could no longer hold.</p>
        <p>Edition of 9, green linen cloth binding with tipped-in cover print. 12 &times; 16 inch fibre-based hand-prints throughout.</p>
        <p class="sold-out">Sold out at OffPrint, Tate Modern, 2025.</p>
    </div>
</main>
</html>