...
.about-text .contact-line a:hover { color: var(--accent); }

@media (max-width: 768px) {
    .about-page { flex-direction: column; }
    .about-image { min-height: 40vh; flex: none; }
    .about-text { width: 100%; min-width: 100%; padding: 32px 20px; }
}
</style>
<html>
...
<main class="about-page">
    <div class="about-image">
        <img src="../assets/images/bjp-feature.jpg" alt="Leah Mclaine">
    </div>
    <div class="about-text">
        <h1>About</h1>
        <p>Leah Mclaine is a Malaysian-British photographer and writer, born 2001 in Newcastle, England. She completed her BA in Theology and Anthropology at Trinity College, Cambridge before pursuing an MA in Photography at the Royal College of Art, where she received the Leverhulme Scholarship.</p>
        <p>Her work emerges from growing up queer within orthodox messianic Judaism and subsequent estrangement from that world. Through analogue photography &mdash; 35mm and medium format black and white film, hand-printed in the darkroom &mdash; she explores what remains when belief departs.</p>
        <p>Her debut book <em>Having Had Faith</em> (edition of 9) sold out at OffPrint, Tate Modern 2025. Winner of the Labyrinth Photographic Prize. Shortlisted for the Taylor Wessing Portrait Prize, National Portrait Gallery.</p>
        <div class="contact-line">
            <a href="https://instagram.com/leahmclaine">@leahmclaine</a>
            <a href="../bookings/">Bookings &rarr;</a>
        </div>
    </div>
</main>
</html>